...
from common import ensure_output_dir, namespace_to_config, plot_single_method, save_result_bundle, train_reward_max


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the reward-max baseline on the same 2D Gaussian-mixture landscape.")
    ...
    parser.add_argument("--run-name", type=str, default="reward_max", help="Run name used to create the output folder.")  ## 本次实验的名字，会写进输出目录名
    return parser
